# gf-petitions-addon
Add petition functionality to Gravity Forms

# How it works:
Install & activate (requires Gravity Forms plugin).

<img width="957" alt="image" src="https://github.com/user-attachments/assets/cefea027-169f-46f8-b4fd-4e5dab148d0f" />
New settings screen with petitions-specific options, including initial signature count set (or adjustment to factor in offline signatures), auto increasing target, and social share options under the confirmation message at the end screen.

By enabling petition mode on a form, you will be add an entry count + target to the front end of your form, ie.
